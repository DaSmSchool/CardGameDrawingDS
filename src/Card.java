...
public class Card {
    ...
    private static ArrayList<Card> currDeck;

    public Card(String suit, String value) {
        ArrayList<Card> currDeck = new ArrayList<Card>();
        this.suit = suit;
        this.value = value;
    ...
    public static ArrayList<Card> buildHand() {
        currDeck = Card.buildDeck();
        ArrayList<Card> hand = new ArrayList<Card>();
        for (int i = 0; i < 9; i++) {
            int r = (int)(Math.random()*currDeck.size());
            Card c = currDeck.remove(r);
            hand.add(c);
        }
        return hand;
    }
